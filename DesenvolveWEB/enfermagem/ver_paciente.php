...
<head>
    ...
    <title>Ver Paciente | Checagem à Beira Leito</title>
                ...
                ?>
                    <div class="row g-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <p class="form-control">
                                <?= date('d/m/Y', strtotime($paciente['dtNascPaciente'])) ?>
                            </p>
                        </div>
                    </div>
                    <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-sm">
                            ...
                            <p class="form-control">
                                <?= $paciente['endPaciente']?>
                            </p>
                        </div>
                        <div class="col-sm-3">
                            <label for="dtInternacao" class="form-label">Data Internação</label>
                            <p class="form-control">
                                <?= date('d/m/Y', strtotime($paciente['dtInternacaoPaciente'])) ?>
                            </p>
                        </div>
